...
def clip(subject_polygon,clipping_polygon):
    # it is assumed that clipping_polygon is T hat, such the rotation
    # matrix is used to rotate clipping_polygon. No need to track gradients
    # for subject_polygon
    # subject_polygon and clipping_polygon are N x 2 and M x 2 torch tensors
